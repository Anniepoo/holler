;  This is a modification of Mark Volkmann's snake program to use
;  the holler message broadcasting system
...
; Anne Ogborn rewrote it as an example of how to use holler
...
(ns com.ociweb.snake
  ...
  (:use clojure.contrib.import-static holler.core))
